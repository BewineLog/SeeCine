...
import 'package:movie/screens/Page2/constant.dart';
import 'package:movie/screens/Page2/movie_location_autocomplete.dart';
import 'package:movie/screens/Page2/select_movie.dart';
import 'package:http/http.dart' as http;
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:geolocator/geolocator.dart';

// import 'package:kakao_flutter_sdk/all.dart';
// import 'package:movie/screen/kakaoLogin.dart';
...
class CinemaMapState extends State<CinemaMap> {
  ...
  Future<double> _getdistance(
    ...
    // print('설정된 위치로부터'+ dis.toStringAsFixed(2) +'km 거리에 영화관이 있습니다.');
  ...
  void _searchCinema() async {
    ...
    List RadiusRange = [1000, 2000, 5000, 10000, 15000, 30000];
    // var circle;
    int cnt = 0;
